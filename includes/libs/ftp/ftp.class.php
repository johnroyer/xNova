    ...
    */
    ...
    public function connect($config, $useSSL = false, $fallback = false)
    {
        ...
        if (strpos($tmpOS, 'MAC') !== false) {
            $this->serverOS = 'MAC';
        } elseif (strpos($tmpOS, 'WIN') !== false) {
            $this->serverOS = 'WIN';
        } elseif (strpos($tmpOS, 'UNIX') !== false) {
            $this->serverOS = 'UNIX';
        } else {
     ...
     * @return bool
     */
    final protected function removeDirRecursive($dir)
    {
     ...
     */
    final protected function convertSize($filesize)
    {
